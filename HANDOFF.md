...
- Последняя сессия: **12** (2026-08-12: CUE влит и вылечен по битам, релиз
  0.10.0, манифест на двух языках, тёмные скриншоты, скролл 120 fps) — отчёт
  `docs/sessions/progress-report-session12.md`
- Следующая: **13** — kickoff `docs/sessions/SESSION_13_KICKOFF.md`
- Ветка `main`, head — см. `PROGRESS.md`. Тесты **194/194**, Debug без warnings
