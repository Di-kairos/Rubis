...
- ⏳ клавиатура — навигация есть во всех разделах (Tracks, поиск, сетка альбомов,
  артисты, плейлисты) + горячие клавиши §7.6. **Проверить руками:** ↓ из поля поиска
  в результаты и то, что пробел снова набирается в поиске (правка menu key equivalents).
