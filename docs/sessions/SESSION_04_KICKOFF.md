...
## Сделано в конце S03 (не нужно повторять)
- Merge `phase/05-interface` → main: коммит `447a1a1`, main запушен.
- Релиз **0.2.1** в `rubis-releases`: версия 0.2.1 / build 2, DMG подписан EdDSA,
  appcast обновлён, GitHub release создан. Опубликованный DMG побайтово совпадает
  с подписанным (SHA256 сверен), фид отдаётся с raw.githubusercontent.
- Осталось живьём: нажать «Check for Updates…» на установленной 0.2.0.
