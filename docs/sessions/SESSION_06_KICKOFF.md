...
## Фокус S06
1. **Вердикт владельца по Pack 1 (0.4.0) и Pack 2 (0.5.0)** на живой библиотеке → правки.
2. **Pack 3 «Витрина»** (Albums: featured + полка, токен тени «свет витрины»,
   ревизия запрета теней DESIGN §2.3).
Pack 2 выпущен в продолжении S05 (2026-08-08): `DSRulerScale` в транспорте,
бейдж тракта numeric капителью; LibrarySettings скроллится.
